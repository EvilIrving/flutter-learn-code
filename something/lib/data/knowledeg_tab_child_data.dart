class KnowledegTabResult {
  int? curPage;
  List<KnowledegTabDetail>? datas;
  int? offset;
  bool? over;
  int? pageCount;
  int? size;
  ...
  KnowledegTabResult.fromJson(Map<String, dynamic> json) {
    ...
    if (json["datas"] is List) {
      datas = json["datas"] == null
          ? null
          : (json["datas"] as List)
              .map((e) => KnowledegTabDetail.fromJson(e))
              .toList();
    }
...
class KnowledegTabDetail {
  ...
  KnowledegTabDetail.fromJson(Map<String, dynamic> json) {
